...
<div class="ml-[6.25rem] py-1 flex flex-wrap border-b-blue-600" id="addNewPatient">
    <div class="w-[70rem] mt-4 p-10 rounded-md shadow-lg items-center overflow-y-auto max-h-[73vh] mx-auto bg-gray-200 border border-blue-200 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
        ...
        <form id="addPatientForm" action="{{ route("system_admin.add_patient.store") }}" method="POST">
            @csrf
            <div class="grid">
...
<script>
    ...
    $('#doctor_id').change(function () {
        ...
        $.ajax({
            url: '{{ route("system_admin.fetch_available_days") }}',
            type: 'GET',
            data: {
                doctor_id: doctorId
            },
    ...
    $(document).ready(function() {
        $('#doctor_id, #appointment_day').change(function() {
            ...
            $.ajax({
                url: '{{ route("system_admin.fetch_available_times") }}',
                type: 'GET',
                data: {
                    doctor_id: doctorId,
    ...
    $(document).ready(function() {
        $('#submit_btn').click(function(event) {
            ...
            $.ajax({
                url: '{{ route("system_admin.check_appointment_existence") }}',
                type: 'GET',
                data: {
    ...
    $(document).ready(function() {
        $('#search_button').click(function() {
            ...
            $.ajax({
                url: '{{ route("system_admin.search_phone_number") }}',
                type: 'GET',
                data: {
        ...
        $('#id_dropdown').change(function() {
            ...
            $.ajax({
                url: '{{ route("system_admin.fetch_patient_name") }}',
                type: 'GET',
                data: {
    ...
    $(document).ready(function() {
        $('#go_button').click(function() {
            ...
            if (patientId) {
                ...
                let url = '{{ route("system_admin.patient_record.appointment_record.show", ":patientId") }}';
