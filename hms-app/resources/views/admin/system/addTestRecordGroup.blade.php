<div class="w-[60rem] ml-[2rem] overflow-y-auto max-h-[73vh] mx-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
    ...
    <form action="{{ route('system_admin.patient_record.test_block_record.store', $patientID) }}" method="POST">
        @csrf
...
<script>
    ...
    $('#test_name').change(function () {
        ...
        $.ajax({
            url: '{{ route("system_admin.fetch_test_cost") }}', // Use the defined route
            type: 'GET',
            data: {
                test_name: testName
            },
