    ...
    <tr data-id="{{ $patient->id }}">
        <td class="px-3 py-4 w-full border-r border-b border-t border-r-gray-300 border-gray-200 border-t-blue-100">
            <div class="flex gap-4">
                <a href="{{ route("system_admin.edit_patient.edit", $patient->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none" data-tippy-content="Edit Patient">
                ...
                <a href="{{ route("system_admin.patient_record.appointment_record.show", $patient->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none" data-tippy-content="View Appointment">
                    {{--<img src="{{ asset('images/patient/appointment.png') }}" alt="Appointment Icon" class="w-6 h-6">--}}
                    <button>
                        <img src="{{ asset('images/patient/appointment.png') }}" alt="Appointment Icon" class="w-6 h-6">
                    </button>
                </a>
                <a href="{{ route("system_admin.patient_record.test_record.show", $patient->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-1 rounded focus:outline-none" data-tippy-content="View Test">
                    {{--<img src="{{ asset('images/patient/appointment.png') }}" alt="Appointment Icon" class="w-6 h-6">--}}
                    <button>
