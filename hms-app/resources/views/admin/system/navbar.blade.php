<div class="fixed text-black mr-8 rounded-lg shadow-md h-[35rem] transition-all duration-300 navbar bg-gray-300 collapsed" id="navbarContainer" style="width: 80px;">
    ...
    <nav id="navbarMenu" class="transition-all duration-300">
        <ul class="gap-4">
            ...
            <a href="{{ route('system_admin.employee_record') }}" class="navbar-items" data-tooltip="Employee Record">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/employee_record.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Employee Record</span>
                </li>
            </a>
            <a href="{{ route('system_admin.patient_record') }}" class="navbar-items" data-tooltip="Patient Record">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/patient_record.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Patient Record</span>
                </li>
            </a>
            <a href="{{ route('system_admin.doctor_record') }}" class="navbar-items" data-tooltip="Doctor Record">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/doctor_record.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Doctor Record</span>
                </li>
            </a>
            <a href="{{ route('system_admin.test_records.test_reports') }}" class="navbar-items" data-tooltip="Test Report">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/medical_report.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Test Report</span>
                </li>
            </a>
            <a href="{{ route('system_admin.employee_record') }}" class="navbar-items" data-tooltip="Accounting Record">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/account_record.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Accounting Record</span>
                </li>
            </a>
            <a href="{{ route('system_admin.logout') }}" class="navbar-items" data-tooltip="Logout">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
    ...
    <form id="logoutForm" action="{{ route('system_admin.logout') }}" method="POST" style="display: none;">
        @csrf
    </form>
