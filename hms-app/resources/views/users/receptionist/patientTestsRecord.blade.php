            ...
            <div
                ...
                <div class="overflow-x-scroll overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 max-h-full">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        @include('users.receptionist.patientTestsRecordTable', ['patientTestRecords' => $patientTestRecords])
                        </tbody>
                    </table>
                </div>
            </div>
...
<div id="addTestModal"
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        @include('users.receptionist.addPatientTestRecord')
    </div>
</div>
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('keyup', '#searchInput', function (e) {
            ...
            $.ajax({
                url: "{{ route('receptionist_user.test_record.search_tests', $testID) }}",
                method: 'GET',
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: `/test_records/calculate_total_cost/${patient_test_id}`, // Replace with your backend endpoint
            type: 'GET',
            success: function (response) {
