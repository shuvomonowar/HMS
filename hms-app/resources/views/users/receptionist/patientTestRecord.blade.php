        ...
        <div
            ...
            <div class="overflow-x-scroll overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 max-h-full">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    @include('users.receptionist.patientTestRecordTable', ['patientTests' => $patientTests])
                    </tbody>
                </table>
            </div>
        </div>
...
<div id="addTestModal"
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        @include('users.receptionist.addPatientTestBlock');
    </div>
</div>
...
<script>
    ...
    function deletePatientTest(testId) {
        ...
        function confirmDelete() {
            $.ajax({
                url: `/user/receptionist/patient_record/patient_test/${testId}`,
                type: 'DELETE',
                headers: {
    ...
    $(document).ready(function () {
        $(document).on('keyup', '#searchInput', function (e) {
            ...
            $.ajax({
                url: "{{ route('receptionist_user.test_record.search_test', $patientID) }}",
                method: 'GET',
