...
<div class="flex flex-1">
    ...
    <!-- Content Area -->
    <div class="mt-[5rem] ml-[9.4rem] py-1 flex flex-wrap" id="patientAppointmentRecordContainer">
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('keyup', '#searchInput', function (e) {
            ...
            $.ajax({
                url: "{{ route('receptionist_user.patient_record.appointment_record.search') }}",
                method: 'GET',
