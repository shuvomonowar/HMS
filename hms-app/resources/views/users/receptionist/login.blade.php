...
<div class="mt-[11.2rem] mx-[35rem] bg-gray-100 p-6 sm:p-10 rounded-lg shadow-md max-w-md w-full">
    <h2 class="text-3xl font-medium mb-5 text-center text-blue-500 font-serif">Receptionist User Login</h2>
    <form action="{{ route('receptionist_user.login') }}" method="POST">
        @csrf
        <div class="mb-4">
