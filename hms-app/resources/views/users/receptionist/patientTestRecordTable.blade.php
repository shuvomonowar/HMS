    ...
    <tr data-id="{{ $test->id }}">
        <td class="px-4 py-4 whitespace-no-wrap w-1/6 border-r border-b border-t border-r-gray-300 border-gray-200 border-t-blue-100">
            <div class="flex gap-4 ml-[3rem]">
                ...
                <a href="{{ route("receptionist_user.patient_record.test_records.show", $test->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-1 rounded focus:outline-none" data-tippy-content="View Test Records">
                    <button>
