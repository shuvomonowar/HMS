<div class="fixed text-black mr-8 rounded-lg shadow-md h-[35rem] transition-all duration-300 navbar bg-gray-300 collapsed" id="navbarContainer" style="width: 80px;">
    ...
    <nav id="navbarMenu" class="transition-all duration-300">
        <ul class="gap-4">
            <a href="{{ route('receptionist_user.dashboard', ['username' => Session::get('username')]) }}">
            ...
            <a href="{{ route('receptionist_user.patient_record') }}" class="navbar-items" data-tooltip="Patient Record">
            ...
            <a href="{{ route('receptionist_user.doctor_record.appointment_records') }}" class="navbar-items" data-tooltip="Doctor Record">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
            ...
            {{--<a href="{{ route('system_admin.employee_record') }}">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
                    <img src="{{ asset('images/navbar/profile_account.png') }}" alt="View Icon" class="w-6 h-6 mr-2">
                    <span class="item-text font-thin">Profile & Account</span>
                </li>
            </a>--}}
            <a href="{{ route('receptionist_user.test_records.test_reports') }}" class="navbar-items" data-tooltip="Test Report">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
            ...
            <a href="{{ route('receptionist_user.logout') }}" class="navbar-items" data-tooltip="Logout">
                <li class="px-6 py-3 hover:bg-gray-300 transition duration-300 navbar-item flex items-center">
    ...
    <form id="logoutForm" action="{{ route('receptionist_user.logout') }}" method="POST" style="display: none;">
        @csrf
    </form>
