    ...
    <tr data-id="{{ $schedule->id }}">
        <td class="px-4 py-4 whitespace-no-wrap w-1/6 border-r border-b border-t border-r-gray-300 border-gray-200 border-t-blue-100">
            <div class="flex gap-4 ml-[1.6rem]">
                <a href="{{ route("doctor_user.edit_schedule.edit", $schedule->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none" data-tippy-content="Edit Schedule">
