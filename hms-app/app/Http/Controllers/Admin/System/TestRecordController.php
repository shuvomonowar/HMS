...
class TestRecordController extends Controller
{
    ...
    public function index(): View|\Illuminate\Foundation\Application|Factory|Application
    {
        ...
        return view('system_admin.testRecords', compact('patientTestRecords'));
    }


    /**
     * Show the form for creating a new test record.
     *
    ...
    public function create(): \Illuminate\Foundation\Application|View|Factory|Application
    {
        ...
        return view('system_admin.addTestRecord');
    }
    ...
    public function storeTestGroup(PatientTestBlockRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            if ($testRecord) {
                // dd($validatedData);
                return redirect()->route('system_admin.patient_record.test_record.show', $validatedData['patient_id'])->with('add_test_success', 'New test record group created successfully.');
            } else {
                // dd($validatedData);
    ...
    public function store(PatientTestRecordRequest $request, int $testID): RedirectResponse
    {
        ...
        try {
            ...
            if ($testRecord) {
                // dd($validatedData);
                return redirect()->route('system_admin.patient_record.test_records.show', $testID)->with('add_test_success', 'New test record created successfully.');
            } else {
                // dd($validatedData);
                return redirect()->back()->withInput()->with('add_test_error', 'Failed to create new test record. Please try again.');
            }
    ...
    /**
     * Retrieve all test record group for a given patient.
     *
     * @param int $patientId
     * @return Application|Factory|View|\Illuminate\Foundation\Application
     */
    public function show(int $patientId): \Illuminate\Foundation\Application|View|Factory|Application
    {
        ...
        return view('admin.system.testRecordGroup', compact('patientTests'), ['doctors' => $doctors, 'patientID' => $patientId]);
    }

    /**
     * Retrieve all test records for a given patient.
     *
     * @param int $testId
     * @return Application|Factory|View|\Illuminate\Foundation\Application
     */
    public function show_tests(int $testId): \Illuminate\Foundation\Application|View|Factory|Application
    {
        ...
        return view('admin.system.testRecord', compact('patientTestRecords'), ['doctors' => $doctors, 'tests' => $tests, 'testID' => $testId]);
    }
    ...
    public function edit(int $patientTestId): View|\Illuminate\Foundation\Application|Factory|Application
    {
        ...
        return view('admin.system.editTestRecord', compact('patientTestRecord'), ['doctors' => $doctors, 'patientTestId' => $patientTestId]);
    }
    ...
    public function update(PatientTestRecordRequest $patientTestRecordRequest, int $patientTestId): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('system_admin.patient_record.test_records.show', $validatedData['patient_test_id'])->with('edit_test_success', 'Test record updated successfully.');
        } catch (Exception $e) {
            dd($e);
    ...
    public function destroyTests(int $testId): JsonResponse
    {
        try {
            ...
            return response()->json(['success' => 'Patient test record deleted successfully']);
        } catch (Exception $e) {
            dd($e);
            // return redirect()->back()->withInput()->with('error', 'Failed to delete appointment record. Please try again.');
        }
