...
class ScheduleRecordController extends Controller
{
    ...
    public function index(string $username): View|\Illuminate\Foundation\Application|Factory|Application
    {
        ...
        return view('users.doctor.scheduleRecord', compact('scheduleRecords'), ['doctorID' => $doctorId]);
    }
    ...
    public function show(int $doctorId): \Illuminate\Foundation\Application|View|Factory|Application
    {
        ...
        return view('users.system.scheduleRecord', compact('scheduleRecords'), ['doctorID' => $doctorId]);
    }
    ...
    {
        return view('users.doctor.addScheduleRecord', ['doctorID' => $doctorID]);
    }
    ...
    public function store(ScheduleRecordRequest $request): RedirectResponse
    {
        ...
        try {
            $doctorRecord = DoctorRecord::find($validatedData['doctor_id']);
            ...
            if ($scheduleRecord) {
                return redirect()->route('doctor_user.schedule_record', $username)->with('add_schedule_success', 'New schedule record created successfully.');
            } else {
                // dd($validatedData);
    ...
    {
        return view('users.doctor.editScheduleRecord', compact('scheduleRecord'));
    }
    ...
    public function update(ScheduleRecordRequest $scheduleRecordRequest, ScheduleRecord $scheduleRecord): RedirectResponse
    {
        ...
        try {
            ...
            if ($scheduleRecord) {
                return redirect()->route('doctor_user.schedule_record', $username)->with('edit_schedule_success', 'Schedule record updated successfully.');
            } else {
                // dd($scheduleRecord);
